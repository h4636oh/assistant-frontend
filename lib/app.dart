      ...
      if (response is Map && response.containsKey("type")) {
        ...
        switch (response["type"]) {
          ...
          case "airplane":
            ...
            break;
          case "amazon":
            addCardsToMessages<AmazonCard>(
                responseData, "amazon", getAmazonCards);
            break;
          case "airbnb":
            addCardsToMessages<AirbnbCard>(
                responseData, "airbnb", getAirbnbCards);
            break;
          case "booking":
          ...
          case "fashion":
            ...
            break;
          case "movietime":
            addCardsToMessages<MoviesTimingCard>(responseData, "mtime",
                getMoviesTimingCards); // need to integrate
            break;
          case "movieslist":
            addCardsToMessages<MovieList>(responseData, "movieslist",
                getMoviesListCards); // need to integrate
            break;
          case "perplexity":
