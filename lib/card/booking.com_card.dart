...
class BookingCard extends StatelessWidget {
  ...
  const BookingCard({
    ...
    required this.price,
    required this.Brakefast_included,
  });
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Icon(
                    Brakefast_included ? Icons.restaurant : Icons.no_meals,
                    color: Colors.green,
                    size: 18,
                  ),
                  const SizedBox(width: 6),
                  Text(
                    Brakefast_included ? "Breakfast Included" : "No Breakfast",
                    style: const TextStyle(
                      fontSize: 14,
...
List<BookingCard> getBookingCards() {
  ...
  return scrapedDataList.map((data) {
    return BookingCard(
      ...
      price: data["price"],
      Brakefast_included: data["Brakefast_included"],
    );
  }).toList();
}
